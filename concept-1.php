...
echo "you inserted data successfully";
}else{
echo "you cannot inserted data successfully";
}

}
if(isset($_REQUEST['delete'])){
$sqll="DELETE FROM student WHERE id= {$_REQUEST['id']}";
if(mysqli_query($conn,$sql)){
...
<input type="submit" value="submit" class="btn btn-primary"  class="form-control" name="submit">
</form>
</div>
<div class="col-sm-6">
